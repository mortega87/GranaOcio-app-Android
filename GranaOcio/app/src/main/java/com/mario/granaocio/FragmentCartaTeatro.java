 ...
 */
public class FragmentCartaTeatro extends Fragment implements View.OnClickListener{

    static int id;
    private Context contexto;
    private String titulo;

    public FragmentCartaTeatro() {
        // Required empty public constructor
    }

    public static FragmentCartaTeatro newFragment(int i){
        FragmentCartaTeatro fragmentCarta = new FragmentCartaTeatro();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DataTeatro datos = new DataTeatro();
        ...
        imageView.setImageResource(R.drawable.teatro2);
