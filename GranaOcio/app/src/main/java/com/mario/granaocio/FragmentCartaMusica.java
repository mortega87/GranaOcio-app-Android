 ...
 */
public class FragmentCartaMusica extends Fragment implements View.OnClickListener{

    static int id;
    private Context contexto;
    private String titulo;

    public FragmentCartaMusica() {
        // Required empty public constructor
    }

    public static FragmentCartaMusica newFragment(int i){
        FragmentCartaMusica fragmentCarta = new FragmentCartaMusica();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DataMusica datos = new DataMusica();
