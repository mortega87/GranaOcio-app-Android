 ...
 */
public class FragmentCartaMuseos extends Fragment implements View.OnClickListener{
    ...
    public static FragmentCartaMuseos newFragment(int i){
        FragmentCartaMuseos fragmentCarta = new FragmentCartaMuseos();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DataMuseos datos = new DataMuseos();
